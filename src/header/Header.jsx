...
function Header() {
    return <div className='navbar navbar-dark bg-dark container-fluid  fixed-top'>
        {/* // header logo */}
        ...
        <div className="header__nav">
            ...
            {/* // sign in */}
            <div className="header__option header_ob" style={{ backgroundColor: "transparent" }}>
                <span className="header__optionLineOne">Welcome</span>
                <span className="header__optionLineTwo">Sign In</span>
            </div>
            {/* // cart */}
            <div className="header__optionBasket header_ob">
                <span className='header__optionLineOne'><FontAwesomeIcon icon={faShoppingBasket} />
                </span>
